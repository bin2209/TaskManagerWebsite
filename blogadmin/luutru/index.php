 																...
 																<div class="row no-gutters align-items-center">
 																	...
 																	<div class="col">
 																		<div class="progress progress-sm mr-2">
 																			<div class="progress-bar bg-info" role="progressbar" style="width: 7%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
 																		</div>
 																	</div>
 																</div>
 															</div>
 														...
 														<nav id="tag{{ image.filename }}" class="navbar navbar-light bg-light ng-scope" ng-repeat="image in images">
 															<div class="">
 																<a class="navbar-brand ng-binding" href="#">
 																	<img id="dinhdangfile" src="upload/{{ image.dinhdang }}" alt="" width="30" height="30">{{ image.filename }}
 																</a>
 															</div>
 															<div>
